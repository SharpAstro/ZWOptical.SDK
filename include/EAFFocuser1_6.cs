...
namespace ZWOptical.SDK
{
    public static partial class EAFFocuser1_6
    {
        ...
        [DllImport(EAFSharedLib, EntryPoint = "EAFGetBacklash", CallingConvention = CallingConvention.Cdecl)]
        public static extern EAF_ERROR_CODE EAFGetBacklash(int ID, out int backlash);
#endif
